...
export default function HomeHeroVisual() {
  return (
    <div className="relative h-[300px] w-full max-w-[450px] sm:h-[400px] sm:max-w-[600px] lg:h-[480px] lg:max-w-[720px]" aria-hidden="true">
      <div className="home-hero-globe absolute left-[13.5%] top-[-15%] z-10 aspect-square w-[68%]">
